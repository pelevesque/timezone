<?php
/**
 * Timezone - A class that simplifies timezone picking.
 *
 * @version     1.0
 ...
 * To Do
 *
 * - Add params for select in get_menu(), like id, class, etc...
...
class Timezone
{
     ...
     */
    public static function get_list($time_format = 'h:i a \- \G\M\T P \- ')
    {
        $zones_temp = array();
     ...
     */
    public static function get_menu($time_format = 'h:i a \- \G\M\T P \- ')
    {
        $timezones = static::get_list($time_format);
